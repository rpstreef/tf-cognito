...
variable "cognito_email_message" {
  type        = string
  default     = null
...
variable "cognito_create_route53_record" {
  type    = bool
  default = false
}

variable "cognito_route53_zone_name" {
  type        = string
  default     = null
